...
def _launch_planner(context, *args, **kwargs):
    ...
    cmd = [
        'python3',
        '-m', 'tb3_map_rrt.rrt_planner_node',
        '--ros-args',
        ...
        '-p', f'max_iterations:={lc("max_iterations")}',
        '-p', f'step_size:={lc("step_size")}',
        '-p', f'goal_radius:={lc("goal_radius")}',
        '-p', f'goal_bias:={lc("goal_bias")}',
        '-p', f'smoothing_iterations:={lc("smoothing_iterations")}',
    ]
...
def _launch_follower(context, *args, **kwargs):
    ...
    cmd = [
        'python3',
        '-m', 'tb3_map_rrt.path_follower_node',
        '--ros-args',
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('max_iterations', default_value='9000'),
        DeclareLaunchArgument('step_size', default_value='0.8'),
        DeclareLaunchArgument('goal_radius', default_value='0.7'),
        DeclareLaunchArgument('goal_bias', default_value='0.12'),
        DeclareLaunchArgument('smoothing_iterations', default_value='120'),
        DeclareLaunchArgument('lookahead', default_value='0'),
