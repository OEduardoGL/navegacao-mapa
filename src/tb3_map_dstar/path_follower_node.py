#!/usr/bin/env python3
"""Simple waypoint follower that tracks nav_msgs/Path waypoints."""
...
class PathFollower(Node):
    def __init__(self) -> None:
        super().__init__('tb3_dstar_path_follower')
        ...
        self.declare_parameter('lookahead', 2)
    ...
    def _on_odom(self, msg: Odometry) -> None:
        ...
        # Advance waypoints if already reached
    ...
    def _publish_pose(self, odom: Odometry) -> None:
        ...
        pose_msg.pose.position.x += self._offset_x
        pose_msg.pose.position.y += self._offset_y
